    ...
    <div className="portal-root">
      ...
      <section className="portal-page">
        ...
        {loading ? (
          ...
          <div className={`portal-tickets-shell${selectedTicketView ? ' ticket-selected' : ''}`}>
                ...
                return (
                  ...
                  >
                    <div className="portal-tickets-list-head">
                      <div className="portal-ticket-requester">{ticket.requesterName || user?.name || 'End User'}</div>
                      <div className="portal-ticket-id">ID:{ticket.ticketId || ticket.id}</div>
                    </div>
            ...
            <section className="portal-tickets-detail">
              <div className="portal-tickets-detail-top">
                ...
                <div className="portal-tickets-count">{totalCount} records</div>
              </div>
              {!selectedTicketView ? (
