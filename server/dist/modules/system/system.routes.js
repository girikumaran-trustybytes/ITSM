...
router.post('/database/save', (0, rbac_middleware_1.permit)(['ADMIN']), ctrl.saveDatabaseConfig);
router.post('/database/migrate', (0, rbac_middleware_1.permit)(['ADMIN']), ctrl.migrateDatabaseConfig);
