...
exports.listIncidentsQuerySchema = zod_1.z.object({
    ...
    page: zod_1.z.preprocess((v) => (typeof v === 'string' ? parseInt(v, 10) : v), zod_1.z.number().int().positive().max(MAX_INCIDENTS_PAGE).optional()),
    limit: zod_1.z.preprocess((v) => (typeof v === 'string' ? parseInt(v, 10) : v), zod_1.z.number().int().positive().max(MAX_INCIDENTS_LIMIT).optional()),
});
