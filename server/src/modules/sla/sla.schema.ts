...
export const slaCreateBodySchema = z.object({
  ...
  applyMatch: z.string().optional(),
  conditions: z.array(z.record(z.any())).optional(),
  responseEscalations: z.array(z.record(z.any())).optional(),
  resolutionEscalations: z.array(z.record(z.any())).optional(),
  operationalHours: z.string().optional(),
  escalationEmail: z.boolean().optional(),
