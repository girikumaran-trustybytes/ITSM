...
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "googleSub" VARCHAR(255);
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "zohoSub" VARCHAR(255);
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "microsoftSub" VARCHAR(255);
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "avatarUrl" TEXT;
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "mfaTotpSecret" TEXT;
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "mfaTotpTempSecret" TEXT;
ALTER TABLE "User" ADD COLUMN IF NOT EXISTS "mfaTotpEnabled" BOOLEAN DEFAULT FALSE;
...
CREATE INDEX IF NOT EXISTS idx_mfa_challenge_user_id ON "MfaChallenge"("userId");
...
CREATE INDEX IF NOT EXISTS idx_mfa_trusted_device_user_id ON "MfaTrustedDevice"("userId");
...
ALTER TABLE "MfaPolicy" ADD COLUMN IF NOT EXISTS "isConfigured" BOOLEAN NOT NULL DEFAULT FALSE;
...
CREATE INDEX IF NOT EXISTS idx_user_google_sub ON "User"("googleSub");
CREATE INDEX IF NOT EXISTS idx_user_zoho_sub ON "User"("zohoSub");
CREATE INDEX IF NOT EXISTS idx_user_microsoft_sub ON "User"("microsoftSub");

CREATE TABLE IF NOT EXISTS "ServiceAccounts" (
  "id" SERIAL PRIMARY KEY,
  "userId" INTEGER NOT NULL UNIQUE REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE,
