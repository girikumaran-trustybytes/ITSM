...
const ctrl = __importStar(require("./events.controller"));
const router = (0, express_1.Router)();
router.use(auth_middleware_1.authenticateJWT);
router.get('/', (0, rbac_middleware_1.permit)(['ADMIN', 'AGENT']), (0, permission_middleware_1.requirePermission)('itsm.dashboard'), (0, validate_middleware_1.validate)({ query: events_schema_1.eventsListQuerySchema }), ctrl.list);
