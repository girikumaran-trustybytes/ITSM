...
router.post('/:id/send-invite', permit(['ADMIN','AGENT']), authorize('user', 'edit'), ctrl.sendInvite)
router.post('/:id/service-account/invite', permit(['ADMIN','AGENT']), authorize('user', 'edit'), ctrl.sendServiceAccountInvite)
router.post('/:id/service-account/reinvite', permit(['ADMIN','AGENT']), authorize('user', 'edit'), ctrl.reinviteServiceAccount)
router.post('/:id/mark-invite-pending', permit(['ADMIN','AGENT']), authorize('user', 'edit'), ctrl.markInvitePending)
